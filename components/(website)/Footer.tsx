    ...
    <footer className="bg-[#1f1f1f] text-white px-6 py-10 mt-12">
      ...
      <div className="flex justify-center mb-8">
        <div className="flex space-x-6">
          <a href="https://wa.me/919871776559" target="_blank" rel="noopener noreferrer">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li><Link href="/" className="hover:text-[#e63946]">Home</Link></li>
            <li><Link href="/about" className="hover:text-[#e63946]">About</Link></li>
            <li><Link href="/blogs" className="hover:text-[#e63946]">Blogs</Link></li>
            <li><Link href="/products" className="hover:text-[#e63946]">Products</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li>
              <Link href="/quickLinks/privacy-policy" className="hover:text-[#e63946]">
                Privacy Policy
              </Link>
            </li>
            <li>
              <Link href="/quickLinks/contact-information" className="hover:text-[#e63946]">
                Contact Information
              </Link>
            </li>
            <li>
              <Link href="/quickLinks/terms-and-conditions" className="hover:text-[#e63946]">
